...
import {
    ...
    Drawer, CssBaseline, MenuList, MenuItem, Divider, withStyles
    ...
    const drawer = (
      <div>
        ...
        <MenuList>
          ...
          <MenuItem component={Link} to='/about' selected={'/about'===pathname} onClick={this.handleDrawerToggle}>
            About
          </MenuItem>
          <MenuItem component={Link} to='/todo' selected={'/todo'===pathname} onClick={this.handleDrawerToggle}>
            TodoApp
          </MenuItem>
          <MenuItem component={Link} to='/contact' selected={'/contact'===pathname} onClick={this.handleDrawerToggle}>
            Contact
          </MenuItem>
          <Divider />
        </MenuList>
